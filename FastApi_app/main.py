...
def get_cars(brand_name: str = Path(..., description='name of brand'),
    ...
    if verify_token(token):
        ...
        return crud.get_cars(db=db, brand_name=brand_name, model_name=model_name,page=page, limit=limit, sortby=sortby, orderby=orderby)
